package com.cn.runzhong.joke.view.photodraweeview;
...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    public interface OnPhotoLoadListener{
        void onFinalImageSet(String id, ImageInfo imageInfo,
                ...
                .setControllerListener(new BaseControllerListener<ImageInfo>() {
                    ...
                    public void onFinalImageSet(String id, ImageInfo imageInfo,
                        ...
                        if(onPhotoLoadListener!=null){
                            onPhotoLoadListener.onFinalImageSet(id, imageInfo, animatable);
                        }
                    }
